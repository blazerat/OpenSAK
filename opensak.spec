...
# boundary polygon data (generated by tools/boundaries/gsak_to_opensak.py; gitignored).
# Build runners must run the converter before invoking pyinstaller.
_data = Path("data")
...
if (_data / "boundaries.db").exists():
    boundary_datas = [
        ...
        (str(_data / "counties"),      "data/counties"),
    ]
